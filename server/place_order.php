...
if(isset($_POST['place_order'])){
    ...
    $stmt = $conn->prepare("INSERT INTO orders (order_cost, order_status, user_id, user_email, user_phone, user_country, user_address, order_date)
                        VALUE (?,?,?,?,?,?,?,?); ");

    $stmt->bind_param('ssisisss', $order_cost, $order_status, $user_id, $email, $phone, $country, $address, $order_date);
    ...
    foreach($_SESSION['cart'] as $key => $value){
        ...
        //4. saglabāt katru atsevišķo vienumu uz order_items datu bāzē
        ...
        $stmt1->bind_param('iissiisi', $order_id, $product_id, $product_name, $product_image, $user_id, $order_date, $product_price, $product_quantity);
